    ...
    <Dialog open={!!project} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-2xl text-slate-300 font-bold mb-4">Technical Implementation</h3>
          ...
          <div>
            <h3 className="text-2xl text-slate-300 font-bold mb-4">Key Results</h3>
            <ul className="list-disc list-inside space-y-2 text-slate-400">
          ...
          <div>
            <h3 className="text-2xl text-slate-300 font-bold mb-4">Technologies Used</h3>
